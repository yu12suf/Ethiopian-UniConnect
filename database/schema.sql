...
CREATE TABLE IF NOT EXISTS books (
    ...
    exchange_type ENUM('borrow', 'buy', 'donate') NOT NULL,
    ...
    FULLTEXT INDEX idx_search (title, author, course)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO users (full_name, email, password, department, phone, role, status) 
VALUES ('Admin', 'admin@uniconnect.edu.et', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administration', '0911234567', 'admin', 'active')
